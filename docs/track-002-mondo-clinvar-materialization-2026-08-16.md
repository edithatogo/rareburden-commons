...
`docs/track-002-public-archive-reconciliation-2026-08-27.yml`: it binds 241
assets and 18,084,035,696 bytes through eight completed releases and resumes at
release index 9, asset index 0. Explicit paired coordinates permit bounded
