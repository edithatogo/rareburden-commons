...
PLAN = Path("conductor/archive/012-paediatric-burden-demonstrator/plan.md")
METADATA = Path("conductor/archive/012-paediatric-burden-demonstrator/metadata.json")
REVIEW = Path("conductor/archive/012-paediatric-burden-demonstrator/review.md")
