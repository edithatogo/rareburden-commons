...
PLAN = Path("conductor/archive/011-bronchiectasis-demonstrator/plan.md")
METADATA = Path("conductor/archive/011-bronchiectasis-demonstrator/metadata.json")
REVIEW = Path("conductor/archive/011-bronchiectasis-demonstrator/review.md")
