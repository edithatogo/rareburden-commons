...
PLAN = Path("conductor/archive/013-quality-validation-gap-equity/plan.md")
METADATA = Path("conductor/archive/013-quality-validation-gap-equity/metadata.json")
REVIEW = Path("conductor/archive/013-quality-validation-gap-equity/review.md")
