...
| M-23 Accessible text for diagrams and visualisations | 014, 017 | prose architecture descriptions, documentation policy, bounded static product-set schema and repository-owned accessibility review | **Partial:** synthetic gap, country and demonstrator models require headings, text alternatives and non-colour status labels; independent accessibility audit and real-user review of an exact rendered candidate remain open. |
