...
The plan now records the diagnosed/undiagnosed/modelled state definition as a
completed repository contract, without treating the synthetic states as a
clinical ascertainment result.
