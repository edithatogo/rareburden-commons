...
|---|---|---|
| Language | Python 3.12–3.14 reference implementation | Compatibility with scientific and secure research environments |
...
- Python 3.12, 3.13 and 3.14 are continuously tested on Linux.
