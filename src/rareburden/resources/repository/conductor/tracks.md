...
| 013 | [Quality, validation, gap mapping and equity assurance](./archive/013-quality-validation-gap-equity/index.md) | Complete (bounded exact real-public aggregate validation; release gates retained) | Must | v0.8.0 | Repository owner (sole accountable human) | 003, 005, 007, 010, 011, 012 |
