...
| 008 | [Semantic backbone and burden-purpose hierarchy](./archive/008-semantic-backbone/index.md) | Archived (bounded non-clinical core; external gates remain) | Must | v0.4.0 | Repository owner (sole accountable human) | 002, 007 |
| 009 | [Evidence and parameter ledger](./archive/009-evidence-parameter-ledger/index.md) | Archived (bounded synthetic and receipted-public-aggregate scope; external gates remain) | Must | v0.4.0 | Repository owner (sole accountable human) | 002, 008 |
| 010 | [Public burden engine and uncertainty framework](./archive/010-public-burden-engine/index.md) | Archived (bounded synthetic alpha core; external gates remain) | Must | v0.5.0 | Repository owner (sole accountable human) | 009 |
...
| 004 | [Federated country-node execution package](./archive/004-federated-node-runner/index.md) | Archived (bounded synthetic and experimental real-public-data package; no live custodian linkage or statistical release) | Must | v0.6.0 | Repository owner (sole accountable human) | 006, 009, 010 |
| 011 | [Bronchiectasis rare-aetiology demonstrator](./archive/011-bronchiectasis-demonstrator/index.md) | Archived (synthetic reference; no empirical validation) | Must | v0.6.0 | Repository owner (sole accountable human) | 008, 009, 010 |
...
| 012 | [Collective paediatric rare-disease burden demonstrator](./archive/012-paediatric-burden-demonstrator/index.md) | Archived (synthetic reference; no empirical validation) | Must | v0.7.0 | Repository owner (sole accountable human) | 004, 005, 008, 009, 010 |
| 013 | [Quality, validation, gap mapping and equity assurance](./archive/013-quality-validation-gap-equity/index.md) | Archived (bounded synthetic validation; no empirical claims) | Must | v0.8.0 | Repository owner (sole accountable human) | 003, 005, 007, 010, 011, 012 |
| 014 | [Atlas, API and reproducible release engineering](./archive/014-atlas-api-release/index.md) | Archived (bounded synthetic release candidate; unpublished) | Must | v0.8.0 | Repository owner (sole accountable human) | 002, 009, 010, 013 |
...
| 016 | [Security, reliability, performance and operations](./archive/016-security-reliability-operations/index.md) | Archived (bounded operations hardening; no cloud hosting) | Must | v0.9.0 | Repository owner (sole accountable human) | 004, 014 |
| 017 | [Documentation, adoption, sustainability and stable v1 release](./archive/017-documentation-adoption-v1/index.md) | Archived (bounded v1 documentation, adoption and single-owner release candidate) | Must | v1.0.0 | Repository owner (sole accountable human) | 013, 014, 015, 016 |
