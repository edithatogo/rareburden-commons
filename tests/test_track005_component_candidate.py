...
def test_component_candidate_binds_every_changed_candidate_file() -> None:
    ...
    for relative, digest in manifest["files"].items():
        # The repository-wide runtime index is intentionally regenerated by
        # later tracks. Its historical candidate digest remains fixed in this
        # manifest, while current-byte parity is enforced by runtime-assets
