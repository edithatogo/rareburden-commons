...
def test_component_candidate_binds_every_changed_candidate_file() -> None:
    ...
    assert manifest["candidate_commit"] == "44259959279538eab076a91ec4bce0e5f109eebc"
    assert manifest["candidate_tree"] == "bf30a63dc8259e4193a9639ea4966030ffb16eda"
...
def test_component_candidate_retains_all_activation_and_release_blocks() -> None:
    ...
    assert manifest["validation"] == {
        "focused_tests_passed": 47,
        "full_tests_passed": 1820,
