...
def test_component_candidate_binds_every_changed_candidate_file() -> None:
    ...
    assert manifest["candidate_commit"] == "d813c6251e8892b9f410d04e118ebc4b53525aa2"
    assert manifest["candidate_tree"] == "6a67b5f4d44e8091ad582ab2f1a909803680ee21"
