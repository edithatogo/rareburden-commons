...
def test_component_candidate_binds_every_changed_candidate_file() -> None:
    ...
    assert manifest["candidate_commit"] == "9024de56e0caa72fcb22c1fa324c21344db00acf"
    assert manifest["candidate_tree"] == "965cb961161877b345de944c7458022087838ebe"
