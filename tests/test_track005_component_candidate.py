...
def test_component_candidate_binds_every_changed_candidate_file() -> None:
    ...
    assert manifest["candidate_commit"] == "85d6cf486d9bb1ae356a24f93c2cc0e13deaf08d"
    assert manifest["candidate_tree"] == "04e7b87da9dd89010f19503edc8db490e888220c"
