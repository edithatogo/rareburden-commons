...
| 004 | [Federated country-node execution package](./tracks/004-federated-node-runner/index.md) | Complete (bounded synthetic federated node package; no live custodian linkage) | Must | v0.6.0 | Repository owner (sole accountable human) | 006, 009, 010 |
