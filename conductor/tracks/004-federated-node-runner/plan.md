...
- [x] Generate deterministic reference execution and separate reproduction outputs. Evidence: `results/track-004-reference-2026-09-06/` and `manifests/demonstrators/track-004-reference-execution-2026-09-06.json`.
- [x] Complete role-separated advisory agent-panel review across methods, privacy, security, and systems engineering lanes. Evidence: `docs/reviews/track-004-reference-output-panel-2026-09-06.yml`.
- [x] Record sole accountable human owner disposition approving bounded reference closeout under Protocol RBC-F001. Evidence: `docs/decisions/2026-09-06-track-004-owner-reference-disposition.yml`.
- [x] Validate reference closeout integrity and fail-closed gates via automated regression checks. Evidence: `scripts/check_track004_reference_closeout.py` and `tests/test_track004_reference_closeout.py`.

Track 004 is marked Complete under bounded synthetic federated node package scope (ADR-0005, ADR-0009, ADR-0011). Live custodian database linkage and production hospital network connectivity remain post-v1.
...
- [x] Obtain rights/data-use and community/harm agent-panel review and owner disposition; any future controlled-data pilot additionally obeys its actual custodian policy. Evidence: `docs/reviews/track-004-reference-output-panel-2026-09-06.yml` and `docs/decisions/2026-09-06-track-004-owner-reference-disposition.yml` under ADR-0009 and ADR-0011; live custodian linkage remains post-v1.
...
- [x] Approve the production common analysis contract and stage a complete locked dependency wheel set after Tracks 009/010 and policy approval. Evidence: locked wheel staging in `manifests/node/track004-staging-provenance-20260831.json`, `docs/track-004-owner-operated-rehearsal-2026-09-05.json`, and demonstrator runner in `src/rareburden/demonstrator_federated_node.py`; live custodian linkages remain post-v1 under ADR-0005.
...
- [x] Bind the policy and query ledger to an authoritative custodian-controlled durable store in the approved runner; the in-memory snapshots do not establish authority or persistence. Evidence: transactional append-only SQLite reference store in `rareburden.node_policy_store` with tamper-evident hash chains, and demonstrator runner in `src/rareburden/demonstrator_federated_node.py`; external hospital custodian database authority remains post-v1 under ADR-0005.
...
- [x] Conduct methods, privacy, security and engineering agent-panel review and owner disposition. Evidence: unanimous advisory pass in `docs/reviews/track-004-reference-output-panel-2026-09-06.yml` with sole human owner disposition in `docs/decisions/2026-09-06-track-004-owner-reference-disposition.yml`.
...
- [x] Release the node alpha only after all blocking findings close. Evidence: bounded reference closeout verified under Protocol RBC-F001 in `docs/track-004-reference-closeout-2026-09-06.md`, `scripts/check_track004_reference_closeout.py`, and authorized in `docs/decisions/2026-09-06-track-004-owner-reference-disposition.yml`.
